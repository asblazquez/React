                ...
                <div className="container bottom_border">
                    ...
                    <div className='footer_social'>
                        <a href="https://www.instagram.com/speak.up.tech/">
                            <FaInstagram size="40"  color="#fff" className='me-3'/>
                        </a>
                        <a href="https://www.facebook.com/speak.up.tech/" className='me-3'>
                            <FaFacebook size="40"  color="#fff"/>
                        </a>
                        <a href="https://www.twitter.com/speak.up.tech/" className='me-3'>
                            <FaTwitter size="40"  color="#fff"/>
                        </a>
                        <a href="https://www.instagram.com/speak.up.tech/" className='me-3'>
                            <FaCannabis size="40"  color="#fff"/>
                        </a>
                    </div>
                </div>
